...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Jon Park"
    user-mail-address "accounts@jonpark.dev")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/jon/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/jon/bin" "/profile/bin" "/Users/jon/.npm-packages/bin" "/Users/jon/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
